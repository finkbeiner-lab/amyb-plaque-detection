...
// set parameters for gridSpacing X and Y 
def prefMap = [
...
// This automatically checks scripts folder within the user directory, and assign classes, grid spacing at start-up
class ScriptLoader {
...
// This listener checks if the image is opened and then runs interrater_annotator.groovy 
