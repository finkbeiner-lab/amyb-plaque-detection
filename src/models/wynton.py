...
if __name__ == '__main__':
    ...
    dsets_train, dsets_test = [[VipsJsonDataset(slide_name_fn(slide), json_name_fn(slide), label_names, step=tuple([tile_size // (2 if training else 1)] * 2), size=tuple([tile_size] * 2)) for slide in slides] for slides, training in ((slides_train, True), (slides_test, False))]
