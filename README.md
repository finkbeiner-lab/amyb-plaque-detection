...
## 🌐 Optional: RunPod Inference Setup

Use RunPod to run inference remotely on powerful GPUs.

### Step 1: Sign Up

Get your API key and endpoint from:  
...
Let us know if you need help running inference on your own slides or want to contribute!
